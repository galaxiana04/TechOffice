...
@section('container1') 
    <div class="col-sm-6">
        <h1>Upload Feedback by Manager</h1>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ url("") }}">Home</a></li>
            <li class="breadcrumb-item active">Upload Feedback by Manager</li>
        </ol>
    </div>
@endsection
...
<div class="card card-primary">
    ...
    <div class="card-body">
    <form id="uploadForm" action="{{ route('upload.ManagerFeedback', ['id' => $document->id]) }}" method="POST"
                ...
                <input type="hidden" name="picrule" value="{{ str_replace('Manager ', '', auth()->user()->rule) }}">
