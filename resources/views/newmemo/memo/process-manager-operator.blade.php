...
@if ($document->operator == 'Product Engineering')
    ...
    @if (in_array($yourrule, ['Manager ' . $document->operator, 'MTPR', 'superuser']))
        @php
            $userinformations = $document->feedbacks;
        @endphp
            ...
            <div class="card card-primary card-outline shadow-lg border-0 modern-card">
                <div class="card-header gradient-header">
                    <h3 class="card-title">
                        ...
                        Review Manager {{ $document->operator }}
                    </h3>
                ...
                <div class="card-body modern-body">
                    @foreach ($userinformations as $userinformation)
                        ...
                        @if ($userinformation != '')
                            @if (!in_array($userinformation->level, ['MTPR', $document->SMname]) && (in_array($userinformation->level, ['Manager ' . $document->operator]) || in_array($userinformation->pic, ['Manager ' . $document->operator])))
                                ...
                                @if ($userinformation->level == $yourrule || $userinformation->pic == $yourrule || $yourrule == 'MTPR' || $yourrule == 'superuser')
                                    @if (($level && !in_array($level, ['MTPR'])) || ($pic && in_array($pic, ['Manager ' . $document->operator])))
                                                    ...
                                                    <div class="info-grid">
                                                        ...
                                                        <div class="info-item">
                                                            ...
                                                            <div class="info-content">
                                                                ...
                                                                <span class="info-value">{{ $userinformation->review ?: 'Belum direview' }}</span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="info-item">
                                                            ...
                                                            <div class="info-content">
                                                                ...
                                                                <span class="info-value">{{ $userinformation->author ?: '-' }}</span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="info-item">
                                                            ...
                                                            <div class="info-content">
                                                                ...
                                                                <span class="info-value">{{ $userinformation->sudahdibaca ?: 'Belum' }}</span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="info-item">
                                                            ...
                                                            <div class="info-content">
                                                                <span class="info-label">Tipe Komen</span>
                                                                <span class="info-value">{{ $userinformation->conditionoffile2 ?: '-' }}</span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="info-item">
                                                            ...
                                                            <div class="info-content">
                                                                <span class="info-label">ID Komen</span>
                                                                <span class="info-value">{{ $userinformation->id ?: '-' }}</span>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="info-grid mb-3">
                                            ...
                                            <div class="info-item fade-in" style="animation-delay: 0.1s;">
                                                ...
                                                <div class="info-content">
                                                    ...
                                                    <span class="info-value">{{ $userinformation->hasilreview ?: '-' }}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="info-item fade-in" style="animation-delay: 0.2s;">
                                                ...
                                                <div class="info-content">
                                                    ...
                                                    <span class="info-value">{{ ucfirst($userinformation->conditionoffile ?: '-') }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        @if ($yourrule != 'MTPR')
                                            @if ($document->unitvalidation == 'Aktif' && $document->operatorcombinevalidation == 'Aktif' && $document->manageroperatorvalidation != 'Aktif' && $document->seniormanagervalidation == 'Nonaktif')
                                                ...
                                                @elseif($yourrule == $document->operator)
                    ...
                    @if (!in_array($yourrule, ['MTPR']))
                        @if ($document->unitvalidation == 'Aktif' && $document->operatorcombinevalidation == 'Aktif' && $document->seniormanagervalidation == 'Nonaktif' && !in_array($userinformation->level, ['MTPR', $document->SMname]))
                            <div class="mt-4 pt-3 border-top text-center fade-in">
                                ...
                                <div class="mt-2 text-muted small font-weight-bold">STATUS DOKUMEN</div>
                            </div>
                        @endif
                    @endif
