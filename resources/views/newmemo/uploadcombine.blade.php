        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <li class="breadcrumb-item"><a href="">Upload Combine</a></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
...
<div class="container">
    ...
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">Upload Combine</h3>
        </div>
        <div class="card-body">
            <form id="uploadForm" action="{{ route('new-memo.Combine', ['memoId' => $document->id]) }}" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                @csrf
                @method('PUT')
                <!-- Hidden Input Fields -->
...
<!-- Include SweetAlert script -->
    ...
    <script>
        ...
        function showAlert() {
            Swal.fire({
                title: 'Success',
                text: 'Your feedback has been uploaded successfully!',
                icon: 'success',
        ...
        document.getElementById('uploadForm').addEventListener('submit', function(event) {
            ...
            Swal.fire({
                title: 'Are you sure?',
                text: 'You are about to upload your feedback.',
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    event.target.submit();
                    showAlert(); // Show success message after submission
                }
            });
        });
    </script>
